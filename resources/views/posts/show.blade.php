        ...
        <div class="row card-body">
            <div class="col-8">
                <blockquote class="blockquote mb-0">
                    ...
                    <footer class="blockquote-footer mt-2">created At : <cite
                            title="Source Title">{{ Carbon\Carbon::createFromTimeString($post->created_at)->toDayDateTimeString() }}</cite>
                    </footer>
                    @forelse ($tags as $tag)
            ...
            <div class="col-4">
                <img src="{{ asset($post->postAvatar ?? 'default.jpg') }}" class="rounded float-end card-img-top"
                    alt="...">
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <blockquote class="blockquote mb-0">
                ...
                <footer class="blockquote-footer">created At : <cite
                        title="Source Title">{{ $post->human_readable_date ?? now() }}</cite></footer>
            </blockquote>
        </div>
    </div>
